namespace LeGame.Graphics
{
    ...
    public class FourDirectionSprite : Sprite
    {
        ...
        private readonly Dictionary<MoveDirection, int[]> directionToFrames = 
            new Dictionary<MoveDirection, int[]>
            {
        ...
        private readonly Dictionary<Keys, MoveDirection> keyToDirection = 
            new Dictionary<Keys, MoveDirection>
            {
