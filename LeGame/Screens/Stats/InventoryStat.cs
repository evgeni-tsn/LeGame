namespace LeGame.Screens.Stats
{
    ...
    public class InventoryStat : IStat
    {
        ...
        public InventoryStat()
        {
            this.slots = new[]
                             {
                                 new InventorySlot(653, 105), new InventorySlot(693, 105), new InventorySlot(731, 105), 
                                 new InventorySlot(653, 141), new InventorySlot(693, 141), new InventorySlot(731, 141)
                             };
        }
